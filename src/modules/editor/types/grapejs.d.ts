...
declare module 'grapesjs' {
  ...
  declare class View<T extends Model | undefined = Model, E extends Element = HTMLElement> extends Backbone.View<
    T,
    E
  > {}
  ...
  export type ModuleModelExt<TItem extends ModuleModel | ModuleCollection> =
  ...
  export declare class CanvasModule extends Module<CanvasConfig> {
    /**
  ...
  declare class CategoryView extends View<Category> {
    ...
    template({ pfx, label, catName }: { pfx: string; label: string; catName: string }): string
    /** @ts-ignore */
  ...
  Component> {
     ...
     */
    processDef(
      mdl: Component | ComponentDefinition | ComponentDefinitionDefined
    ): Component | ComponentDefinitionDefined | ComponentDefinition
    onAdd(
      model: Component,
      c?: any,
      opts?: {
  ...
  export declare class PanelManager extends Module<PanelsConfig> {
    panels: Panels
  ...
  export declare class PropertyStack extends PropertyComposite<PropertyStackProps> {
    ...
    getEmptyValueStyle(opts?: { force?: boolean }): PropValues
  ...
  export declare class BlockManager extends ItemManagerModule<BlockManagerConfig, Blocks> {
    blocks: Blocks
  ...
  export { CategoryProperties as BlockCategoryProperties, grapesjs as default }
