      ...
      const enhancedMessages: ChatMessage[] = [
        {
          ...
          content: 'Bạn là GENAI - Trợ lý AI thân thiện và hữu ích. Hãy trả lời câu hỏi của người dùng một cách chi tiết, dễ hiểu và chính xác. Duy trì context của cuộc trò chuyện.',
          timestamp: new Date()
        },
        ...messagesForGemini
      ]
